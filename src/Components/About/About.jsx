	...
	return (
		<div className="">
			<div className="w-[85%] mx-auto bg-[#212F39] p-16  rounded-3xl relative mb-80">
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 sm:absolute gap-40 lg:w-[80%] mt-5 mx-auto">
					<div className="bg-[#0F1C26] rounded-3xl p-5 w-full lg:w-[350px] ">
					...
					<div className="bg-[#0F1C26] rounded-3xl p-5 w-full lg:w-[350px] ">
						<h1 className= "text-3xl sm:text-4xl mb-5">Powerful Third-Party Integrations</h1>
						<p className="font-bold text-[#dddddd]">
